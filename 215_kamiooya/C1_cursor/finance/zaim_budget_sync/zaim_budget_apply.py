...
DEFAULT_GOOGLE_EMAIL = os.environ.get("ZAIM_GOOGLE_EMAIL") or "m19m.hrts83@gmail.com"
DEFAULT_LOGIN_EMAIL = os.environ.get("ZAIM_LOGIN_EMAIL") or DEFAULT_GOOGLE_EMAIL
DEFAULT_LOGIN_PASSWORD = os.environ.get("ZAIM_PASSWORD") or ""
