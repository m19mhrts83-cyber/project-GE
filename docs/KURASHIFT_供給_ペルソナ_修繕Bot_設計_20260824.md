...
### S3 権限・データ源（2026-09-17）

正本: [`docs/KURASHIFT_需給調査_権限とデータ源_20260917.md`](KURASHIFT_需給調査_権限とデータ源_20260917.md)

- スマサテ／SUUMO賃貸経営サポート: **S3 がログインして自律判断**（松野リスク許容）
- 生活保護住宅扶助: 物件住所の **市区町村** を調査し収入ライン検討材料に含める
- S13 神コンセプト命名: 購入後〜募集。S5 ターゲット必須（別 paste）
