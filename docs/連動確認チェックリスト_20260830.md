...
同時に進めるのは **Wave 1（T-01〜T-05）だけ**。最初の通しは **T-01 JarvisBox 往復**。

1. このファイルと Notion `[T-01]` を開く
2. 下の「T-01 手順」を上から触る（対外送信なし）
3. 使える → Jarvis に `T-01 意図OK`／違う → `T-01 変更要望: …`
