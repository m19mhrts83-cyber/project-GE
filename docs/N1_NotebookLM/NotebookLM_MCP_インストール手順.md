...
ほかの MCP で `"/Users/matsunomasaharu2/.nvm/versions/node/v22.22.0/bin/npx"` のようにフルパスを使っている場合は、合わせて次のようにしてもよいです。

```json
"notebooklm": {
  "command": "/Users/matsunomasaharu2/.nvm/versions/node/v22.22.0/bin/npx",
  "args": ["-y", "notebooklm-mcp@latest"]
}
```
