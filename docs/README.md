...
- **神・大家さん倶楽部（採点ツール）**: `目黒さん向け_試行と本番運用の流れ.html` — 成果報告 AI 採点ツールの試行・本番運用の流れ（目黒さん向け）。画像は `採点自動化/image/` を参照。
...
- 打ち合わせ資料（3月）: `https://m19mhrts83-cyber.github.io/project-GE/260308_目黒さん面談_打ち合わせ用.html`
- **試行・本番運用の流れ（採点ツール）**: `https://m19mhrts83-cyber.github.io/project-GE/目黒さん向け_試行と本番運用の流れ.html`
