...
| 流動性合計 | 約 **3,984,041円**（2026-08-14）→ **寄せだけで閉じる**（調達ラダー不要） |
| money-ops | id `88bbac98-…` consulting「寄せ計画確定」。寄せ合計 **920,000円** |
| 寄せ内訳 | SBI本 45万 + SBI副 20万 + MUFG豊明(エアウォレット) 15万 + PayPay(ことら) 12万 |
| plan_ready_due | 2026-08-26（ピンは attention＝計画作成済み・実行待ち） |
| 状態 | **承認待ち**（方針合意のみ）。振込は手動 → 完了後 executing→done |
| やらない | 自動振込・貸付/Bloomo（今回不要）・あかつき元本・SBIコア |
