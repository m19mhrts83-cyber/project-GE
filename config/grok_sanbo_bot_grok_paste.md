...
| 松野の言い方（例） | 社員 | あなたの動き |
|---|---|---|
| 本日分 / 業者 / 開拓 / Phase | S2 業者開拓 | §業者開拓 |
| 週次 batch / キックオフ JSON | S2 | §週次バッチ |
| 調査 / 路線価 / ハザード / Grok調査 | S1 物件調査 | §物件調査 |
| 周辺MAP / Canva / 購入後 | S3 (+ S4) | §周辺MAP |
| 今日何やる / 優先 / 進捗 | 部長 | §デイリー部長 |
| 探索（送信なし） | S2 探索 | YAML のみ |
| 新しい社員 / ○○専門 Bot | 部長 | §新社員 Bot |

**複数タスク** → 順番と **連携** を宣言（例: 「S2 本日分完了後 S1 で deal X 調査」）。
...
```
📋 不動産賃貸 · 今日の提案
1. 【S2 業者開拓】部長へ「本日分」— chubu-004〜006
...
Mac同期はJarvis。週次で --mark 一覧を出す。

（--batch-week --grok-kickoff の JSON を続けて貼る）
```
