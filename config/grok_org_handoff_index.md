...
| **不動産賃貸部長** | Daily · S1–S13（募集クリエイティブ含む） · 日報 | **高（Grok内の実務実行）** | 最終判断 · 送信承認 · `--apply` |
...
| **天気お知らせ** | 朝6:30 · **ch直投のみ**（本人通知不要） | 低（定型） | Jarvis が weather/ に材料 |

**不動産の「実行」例（Grok）**: 本日分パック · S1–S10 連携 · 調査・文案 · `[Grok部長]` 日報。  
...
| 参謀室・週次統括 | `30_shared_working/2026-08-30_参謀室_週次統括/`（B1 ホーク再貼 · B2 日曜20:00 · **40_glucon / 週次必須**） |
| アプリ点検 plan | `~/.cursor/plans/融資Grok週次_アプリ点検_20260830.plan.md` · `docs/アプリ点検_融資Grok週次_20260830.md` |
