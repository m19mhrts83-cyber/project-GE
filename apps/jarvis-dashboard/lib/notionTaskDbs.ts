...
export const NOTION_TASK_LANES: Record<string, NotionLaneConfig> = {
  ...
  kanji: {
    title: "飲み会幹事",
    database_id: "3ccf6bbe-5a76-8147-b53b-cddeb1b411cf",
    data_source_id: "3ccf6bbe-5a76-8182-9a58-000bc93e96aa",
    board_url: "https://app.notion.com/p/3ccf6bbe5a768147b53bcddeb1b411cf",
    title_prop: "プロジェクト名",
    status_prop: "ステータス",
    due_prop: "終了日",
    start_prop: "開始日",
